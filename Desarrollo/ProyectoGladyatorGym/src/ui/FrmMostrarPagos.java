 ...
 * @author Katherine
 */
public class FrmMostrarPagos extends javax.swing.JFrame {
    ...
    public FrmMostrarPagos(Deportista deportista) {
     ...
     public void ponerEnTablaForPago(){
        ...
        for (Pago listaPago1: listaPago) { 
            fila[3]= listaPago1.getIdPago();
            fila[0]= listaPago1.getTipoPago();
            fila[1]= listaPago1.getFechaPago();
            fila[2]= listaPago1.getFechaVencimientoPago();
            modelo.addRow(fila);
    ...
    private void initComponents() {
        ...
        tblDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipo de Pago", "Fecha de Pago", "Fecha de Vencimiento", "Número de Pagos"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMostrarPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
